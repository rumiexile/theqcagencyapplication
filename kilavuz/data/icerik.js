              ...
              bloklar: [
                {
                  ...
                  ogeler: [
                    ...
                    {
                      tr: "Kuruluşun EQAR kaydının yenilenmesi hâlinde kuruluş, yeni kayıt döneminin başlangıç ve bitiş tarihlerini ve yenilemeye esas dış değerlendirme raporunu, mevcut EQAR kaydının sona ermesinden önce “EQAR Kayıt Süresi Güncelleme Başvurusu” aracılığıyla sisteme yükler. Bu başvuru, kapsam genişletme başvurusunun bir parçası olarak yapılır; kapsam genişletme için 2.1'de öngörülen süre koşulları bu başvuruya uygulanmaz. Komisyon tarafından yapılacak inceleme sonucunda Kurul, kuruluşun tescil veya tanınma belgesinin geçerlilik süresinin daha önce verilen karar süresini aşmamak üzere devamına karar verebilir.",
                      en: "Where the organisation's EQAR registration is renewed, the organisation shall upload to the system, before the expiry of its current EQAR registration, the start and end dates of the new registration period and the external review report on which the renewal is based, by means of an “EQAR Registration Period Update Application”. That application is made as part of the scope extension application; the time conditions laid down for scope extension in 2.1 do not apply to it. Following the examination to be carried out by the Commission, the Council may decide that the period of validity of the organisation's registration or recognition certificate shall continue, provided that it does not exceed the period of the decision previously taken.",
                    },
                    {
