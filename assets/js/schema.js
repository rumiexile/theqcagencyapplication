      ...
      steps: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              hint: {
                tr: "Tescil edildiği ülkedeki sicile kayıtlı resmî ad, o ülkenin dilinde.",
                en: "The registered name in the country of establishment, in its own language.",
              },
            },
            {
              type: "text", id: "agency.nameEn", required: true, half: true,
              label: { tr: "Kuruluşun adı (İngilizce)", en: "Organisation name (English)" },
              hint: {
                tr: "Kuruluşun uluslararası yazışmalarda kullandığı İngilizce adı.",
